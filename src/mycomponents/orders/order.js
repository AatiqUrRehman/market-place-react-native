...
class IncommingOrders extends Component {
	state = {
		statusOfList: false,
	};
		...
		return (
			<View style={styles.container}>
				<View style={styles.component1}>
					...
					<View style={styles.component1MiddleData}>
						<View style={styles.component1MiddleDataName}>
							<Text style={{ fontSize: 15 }}>Blanca Mejia</Text>
						</View>
						...
						<View style={styles.component1MiddleDataAddress}>
							<Text style={{ fontSize: 15 }}>San Pedro Sula, Res. La Foresta</Text>
						</View>
					</View>
				...
				<View style={styles.FlexInComponent4}>
					...
					<View style={styles.FlexInComponent4Accept}>
						<TouchableOpacity style={styles.FlexInComponent4AcceptBtn}>
							<Text
								style={{
									textAlign: 'center',
									alignItems: 'center',
...
export default IncommingOrders;
...
// 					</View>
// 					<View style={styles.component1MiddleData}>
// 						<View style={styles.component1RightDataName}>
// 							<Text>Salman</Text>
// 						</View>
// 						<View style={styles.component1RightDataPhone}>
// 							<Text>03075654421</Text>
// 						</View>
// 						<View style={styles.component1RightDataAddress}>
// 							<Text>Gatwala Faislabad</Text>
// 						</View>
// 					</View>
// 					<View style={styles.component1RightData}>
// 						<View style={styles.component1RightDataButton}>
// 							<Text>10</Text>
// 							<Text>min</Text>
// 						</View>
// 					</View>
