					...
					<View style={styles.innerButtonView}>
						{this.state.first ? (
							<TouchableOpacity style={styles.leftButtonTouchableOpacityStyle}>
								<View>
									<Text style={styles.leftButtonTextStyle}>Nueva</Text>
								</View>
							</TouchableOpacity>
						) : (
							<TouchableOpacity
							...
							>
								<View>
									<Text style={styles.afterClickedLeftButtonTextStyle}>Nueva</Text>
								</View>
							</TouchableOpacity>
						)}
						{this.state.second ? (
							<TouchableOpacity style={styles.afterClickedRightButtonTouchableOpacityStyle}>
								<View>
									<Text style={styles.rightButtonTextStyle}>Aceptada</Text>
								</View>
							</TouchableOpacity>
						) : (
							<TouchableOpacity
							...
							>
								<View>
									<Text style={styles.afterClickedRightButtonTextStyle}>Aceptada</Text>
								</View>
							</TouchableOpacity>
						)}
					</View>
