...
import { Add_Catagory } from '../../store/actions/catagoryAction';
                  ...
                  Upload Picture
					...
					>
						<Item floatingLabel last style={{ width: '90%' }}>
							...
							<Input onChangeText={t => this.setState({ catagoryName: t })} />
						</Item>
					</View>
					<View
						style={{
					...
					>
						<TouchableOpacity
							...
							onPress={() => {
								this.props.Add_Catagory(this.state.catagoryName, this.props.CurrentSuperMart._id);
							}}
						>
							<View>
								<Text
